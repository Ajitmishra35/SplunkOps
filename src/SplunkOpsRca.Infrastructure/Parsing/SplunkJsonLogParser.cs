...
public sealed class SplunkJsonLogParser(ISensitiveDataMaskingService maskingService) : ILogParser
{
    ...
    private LogRecord ToLogRecord(JsonElement element)
    {
        ...
        return new LogRecord
        {
            ...
            ClientId = Pick(fields, "clientId", "client_id", "customerId", "customer_id", "accountId", "account_id"),
            UserId = Pick(fields, "userId", "user_id", "user"),
            ThreadId = Pick(fields, "threadId", "thread_id", "thread", "thread.name"),
            ProcessId = Pick(fields, "processId", "process_id", "pid"),
            ProcessName = Pick(fields, "processName", "process_name", "operation", "operationName", "workflow", "flow"),
